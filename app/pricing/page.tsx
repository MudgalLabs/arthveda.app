        ...
        <main className="pb-24">
            ...
            <section className="pt-12 md:pt-16 lg:pt-20">
                ...
                <p className="mt-5 max-w-3xl font-content text-[15px] leading-[1.6] text-text-muted">
                    ...
                    all: monthly, yearly, or pay once.
                </p>
            </section>
            ...
            {/* Plans block — the table (with the Monthly/Yearly/One-time
                interval toggle on its own header row), then the yearly nudge
                and the trial-mechanics footnote. */}
            <div className="mt-24">
                <PlansTable />
