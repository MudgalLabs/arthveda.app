            ...
            <div className="mx-auto mt-24 grid max-w-6xl gap-14 lg:grid-cols-[minmax(0,768px)_220px] lg:items-start lg:justify-center">
                <div className="space-y-20">
                    ...
                    >
                        ...
                        <p className={P}>
                            Angel One&apos;s reports, under{" "}
                            <strong>Account</strong> then{" "}
                            <strong>Trades and charges</strong> in the app, are
                            solid for what they cover:
                        </p>
                        <ul className="space-y-2 pl-5">
                            <BulletItem>
                                <strong>Trade history</strong> — your executed
                                trades across equity and F&amp;O, exportable as a
                                file
                            </BulletItem>
                            <BulletItem>
                        ...
                        <p className={P}>
                            Useful, but notice the shape. Angel One&apos;s
                            reports are optimised for the document your
                            accountant needs, because that&apos;s what most
                            retail traders explicitly ask for. The other
                            artifact, the one that actually moves your edge, is
                            the one most Angel One users end up building
                    ...
                    >
                        ...
                        <p className={P}>
                            Once your Angel One trades are in, Arthveda becomes
                        ...
                        <p className={P}>
                            ...
                            trade history the moment you upload it.
                        </p>
                        <p className={P}>
                            ...
                            feedback a raw trade history will never volunteer.
                        </p>
                    </section>
