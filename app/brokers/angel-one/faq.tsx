...
const FAQS: { q: string; a: React.ReactNode }[] = [
    {
        ...
        a: (
            <>
                Arthveda imports your Angel One trade history, groups executions
    ...
    },
    {
        ...
        a: (
            <>
                Yes. Your Angel One trade history exports equity, futures, and
                options in one file, and Arthveda parses all three. Arthveda
                reads the segment and contract on each row, so a NIFTY option or
                a stock future comes in as the right instrument with the right
    ...
    },
    {
        ...
        a: (
            <>
                File upload, for Angel One. Export your trade history from the
                Angel One app and import it into Arthveda. Angel One
                doesn&apos;t offer trade sync yet, so to add fresh trades later
                you export a new trade history for the recent date range and
                import it again.
            </>
        ),
    },
    ...
    },
    {
        ...
        a: (
            <>
                ...
                transaction charges are computed from the standard Angel One
                rate card. The PnL Arthveda shows you is after charges, which is
                the only PnL that actually matters.
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                journal current. A good habit is to download your trade history
                every weekend and tag the week&apos;s trades while the reasoning
                is still fresh. Since Angel One has no sync, just export the new
...
export default function AngelOneFAQ() {
