...
export default function GrowwLandingPage() {
    return (
        <main className="pb-24">
            ...
            <BrokerJournalShowcase brokerName="Groww" />

            <BrokerTrustStrip broker={GROWW} />
            ...
            <div className="mx-auto mt-24 grid max-w-6xl gap-14 lg:grid-cols-[minmax(0,768px)_220px] lg:items-start lg:justify-center">
                <div className="space-y-20">
                    ...
                    >
                        ...
                        <p className={P}>
                            Groww shows you your trades and PnL reports, the
                        ...
                        <p className={P}>
                            ...
                            most Groww users end up building themselves in Excel,
