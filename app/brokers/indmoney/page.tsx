...
import INDmoneyFAQ from "./faq";

const INDMONEY = BROKERS.find((b) => b.name === "INDmoney")!;

export const metadata: Metadata = {
    title: "Trading Journal for INDmoney Users: From Tradebook to Real Insights · Arthveda",
    description:
        "Turn your INDmoney tradebook into a trading journal with performance analytics, insights, reports, tags, notes, and trade-level feedback in under five minutes.",
    alternates: { canonical: "/brokers/indmoney" },
    openGraph: {
        title: "Trading Journal for INDmoney Users: From Tradebook to Real Insights",
        description:
            "Turn your INDmoney tradebook into a trading journal with performance analytics, insights, reports, tags, notes, and trade-level feedback in under five minutes.",
        url: "https://arthveda.app/brokers/indmoney",
        type: "article",
        images: [
            {
                ...
                height: 630,
                type: "image/jpeg",
                alt: "Trading Journal for INDmoney Users · Arthveda",
            },
        ],
    },
    twitter: {
...
// Plain-text mirror of app/brokers/indmoney/faq.tsx, used only for the FAQPage
// JSON-LD. Keep in sync with the accordion copy.
const FAQ_SCHEMA = [
    {
        q: "What can Arthveda do with my INDmoney trades?",
        a: "Arthveda imports your INDmoney tradebook, groups executions into trades, calculates after-charges PnL, and gives you a dashboard, trade list, journal notes, tags, insights, and reports.",
    },
    {
        q: "Does Arthveda support F&O for INDmoney?",
        a: "Equity and options, yes. Arthveda reads your INDmoney tradebook and brings in stocks and options automatically, detecting the CE/PE contract on each row. Futures import isn't built yet, but INDmoney does export it, so ping us a sample tradebook and we can add it. The journal itself handles everything you trade, and the one stock-only surface is the screener (NSE/BSE equities).",
    },
    {
        q: "Is there a sync, or is it file upload only?",
        a: "File upload, for INDmoney. Export your tradebook (Excel or CSV) from the INDmoney app and import it into Arthveda. INDmoney doesn't offer trade sync yet, so to add fresh trades later you export a new tradebook for the recent date range and import it again.",
    },
    {
    ...
    },
    {
        ...
        a: "Brokerage, STT, GST, stamp duty, SEBI charges, and exchange transaction charges are computed from the standard INDmoney rate card. The PnL Arthveda shows you is after charges, which is the only PnL that actually matters.",
    },
    {
        q: "How often should I import?",
        a: "There is no fixed rule. A weekly or monthly export keeps your journal current. A good habit is to export your tradebook every weekend and tag the week's trades while the reasoning is still fresh. Since INDmoney has no sync, just export the new date range since your last import and upload it again.",
    },
];
...
const SECTIONS = [
    { id: "what-indmoney-shows", label: "What INDmoney shows" },
...
export default function INDmoneyLandingPage() {
    return (
        <main className="pb-24">
            ...
            <section className="pt-12 md:pt-16 lg:pt-20">
                <div>
                    ...
                    <h1 className="mt-5 max-w-4xl text-balance font-heading text-[40px] font-medium leading-[1.04] tracking-[-0.025em] text-text-primary sm:text-[52px] lg:max-w-none lg:text-[60px]">
                        Turn your INDmoney tradebook into a trading journal you
                        can actually learn from.
                    </h1>
                    <p className="mt-5 max-w-3xl font-content text-[15px] leading-[1.6] text-text-muted">
                        INDmoney gives you trades. Arthveda gives you insights
                        and analytics. See how you can turn your INDmoney
            ...
            >
                <LitMedia
                    ...
                    captionDescription="PnL, charges, duration, chart context, executions, notes, and tags, all tied to the same INDmoney trade."
                />
            </div>

            <BrokerJournalShowcase brokerName="INDmoney" />

            <BrokerTrustStrip broker={INDMONEY} />
            ...
            <div className="mx-auto mt-24 grid max-w-6xl gap-14 lg:grid-cols-[minmax(0,768px)_220px] lg:items-start lg:justify-center">
                <div className="space-y-20">
                    ...
                    <section className="space-y-5">
                        <p className={P}>
                            If you trade on INDmoney and your history lives in
                            tradebook exports, this guide shows how to turn that
                            file into a journal you can actually learn from.
                        </p>
                        <p className={P}>
                            You have a couple of hundred trades sitting in your
                            INDmoney account. You roughly know last quarter was
                    ...
                    <section
                        id="what-indmoney-shows"
                        className="scroll-mt-28 space-y-5"
                    >
                        <h2 className={H2}>What INDmoney actually shows you</h2>
                        <p className={P}>
                            INDmoney shows you your trades and PnL reports, the
                        ...
                        <p className={P}>
                            ...
                            most INDmoney users end up building themselves in
                    ...
                    >
                        ...
                        <p className={P}>
                            None of these are answerable from INDmoney&apos;s
                            reports without exporting your tradebook, opening
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <Step
                                n="1"
                                title="Export your tradebook from INDmoney"
                            >
                                In the{" "}
                                <Link
                                ...
                                app, open Stocks, go to Manage (or the Reports
                                section), pick Tradebook or Transaction History,
                                choose your date range, and download the Excel or
                                CSV. If you can&apos;t find it, the Tax Filing
                                Report usually carries a Trades tab with the same
                                details.
                            </Step>
                            <Step
                                n="2"
                                title="Create your INDmoney broker account"
                            >
                                Sign up or log in to Arthveda. Follow onboarding
                                and select INDmoney, or go to{" "}
                                <Link
                                    href={APP_BROKER_ACCOUNTS_URL}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                ...
                                and create an INDmoney broker account.
                            </Step>
                            <Step
                                n="3"
                                title="Click Import and upload the file"
                            >
                                Choose Import on the INDmoney broker account,
                                upload the tradebook file, review the parsed
                                ...
                                computed for you. Options contracts are read
                                straight from the file, with the right underlying
                                and strike.
                            </Step>
                        ...
                        <p className={P}>
                            ...
                            INDmoney doesn&apos;t offer trade sync yet, so when
                            you want to add fresh trades, export a new tradebook
            ...
            <div className="mx-auto mt-20 max-w-3xl rounded-lg border border-white/[0.12] bg-surface-1/35 px-6 py-10 text-center md:mt-24">
                <h2 className="mx-auto max-w-2xl text-balance font-heading text-[28px] font-medium leading-tight tracking-[-0.015em] text-text-primary sm:text-[34px]">
                    Turn your INDmoney tradebook into a journal you can actually
                    learn from.
                </h2>
                <div className="h-6" />
