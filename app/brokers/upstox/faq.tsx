...
const FAQS: { q: string; a: React.ReactNode }[] = [
    {
        ...
        a: (
            <>
                Arthveda imports your Upstox trade report, groups executions
                into trades, calculates after-charges PnL, and gives you a
                dashboard, trade list, journal notes, tags, insights, and
                reports.
            </>
        ),
    },
    {
        ...
        a: (
            <>
                Equity and options, yes. Arthveda reads your Upstox trade report
                and brings in stocks and options automatically, resolving each
                contract to the right underlying, expiry, and strike. Futures
                import isn&apos;t built yet, but Upstox does export it, so ping
                us a sample report and we can add it. The journal itself handles
                everything you trade, and the one stock-only surface is the
    ...
    },
    {
        ...
        a: (
            <>
                File upload, for Upstox. Download your trade report (XLSX) from
                the Upstox Reports section and import it into Arthveda. Upstox
                doesn&apos;t offer trade sync yet, so to add fresh trades later
                you download a new report for the recent date range and import
                it again.
            </>
        ),
    },
    ...
    },
    {
        ...
        a: (
            <>
                ...
                transaction charges are computed from the standard Upstox rate
    ...
    },
    {
        ...
        a: (
            <>
                ...
                journal current. A good habit is to download your trade report
                every weekend and tag the week&apos;s trades while the reasoning
                is still fresh. Since Upstox has no sync, just download the new
                date range since your last import and upload it again.
            </>
        ),
    },
];

export default function UpstoxFAQ() {
