...
const FAQS: { q: string; a: React.ReactNode }[] = [
    {
        ...
        a: (
            <>
                Arthveda imports your Kotak Securities trade report, groups
    ...
    },
    {
        ...
        a: (
            <>
                Yes. Your Kotak Securities report carries equity, futures, and
                options, and Arthveda parses all three. It reads the exchange
                and contract on each row, so a NIFTY option or a stock future
                comes in as the right instrument with the right expiry and
                strike. The journal itself handles everything you trade, and the
                one stock-only surface is the screener (NSE/BSE equities).
            </>
        ),
    },
    {
        ...
        a: (
            <>
                File upload, for Kotak Securities. Download your trade report
                from Performance &amp; Reports and import it into Arthveda. Kotak
    ...
    },
    {
        ...
        a: (
            <>
                ...
                transaction charges are computed from the standard Kotak
                Securities rate card. The PnL Arthveda shows you is after
                charges, which is the only PnL that actually matters.
            </>
        ),
    },
    {
        ...
        a: (
            <>
                ...
                still fresh. Since Kotak has no sync, just download the new date
...
export default function KotakSecuritiesFAQ() {
