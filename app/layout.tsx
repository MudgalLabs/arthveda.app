...
const TITLE = "Find where you're losing money in your trades | Arthveda";
const DESCRIPTION =
    "Arthveda shows where you're losing money in your trades — and how to fix it. Built for Indian traders. Works with Zerodha, Upstox, Groww, and more.";
