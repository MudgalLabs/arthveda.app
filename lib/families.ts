...
export const FAMILIES: ProductFamily[] = [
    {
        key: "discover",
        name: "Discover",
        tagline: "Find ideas. Track what happened next.",
    ...
    },
    {
        ...
        blurb: "Log or import your trades, journal the decisions behind them, then use analytics and insights to see where you make money, where you lose it, and what to fix.",
